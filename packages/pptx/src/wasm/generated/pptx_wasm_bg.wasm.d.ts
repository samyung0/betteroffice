...
export const __wbg_pptxcheckpointrebase_free: (a: number, b: number) => void;
export const __wbg_pptxdocument_free: (a: number, b: number) => void;
export const pptxcheckpointrebase_indexedState: (a: number) => [number, number];
export const pptxcheckpointrebase_state: (a: number) => [number, number];
...
export const pptxdocument_rebaseCheckpoint: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => [number, number, number];
